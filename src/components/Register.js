...
const Register = (props) => {
  ...
  const onChangeDateBirthday = (e) => {
    const dateBirthday = e.target.value;
    setDateBirthday(dateBirthday);
  };

  const onChangeSetSex = (e) => {
        ...
        <Form onSubmit={handleRegister} ref={form}>
          {!successful && (
            <div>
              ...
              <div className="form-group">
                <label htmlFor="pprefix">Phone prefix</label>
                <Input
                  className="form-control"
                  name="pprefix"
                  value={phonePrefix}
              ...
              <div className="form-group">
                <label htmlFor="pprefix">Phone number</label>
                <Input
                  className="form-control"
                  name="pphone"
                  value={phoneNumber}
